    ...
    P: DenseUVPolynomial<F>,
{
    ...
    fn generate_proof(
        ...
        let t = calculate_t::<F>(RHO_INV, SEC_PARAM,ext_mat.n); // TODO this function will now probably need to take into account the number of rows/cols of the extended matrix
    ...
    D: Digest,
{
        ...
        Self::Commitment: 'a,
    {
        ...
        for (i, labeled_commitment) in labeled_commitments.iter().enumerate() {
            ...
            let t = calculate_t::<F>(RHO_INV, SEC_PARAM, commitment.n_ext_cols); // TODO include in ck/vk?
